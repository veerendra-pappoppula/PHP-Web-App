...
$sql="select * from datasets_columns where lower(dataset_name)=lower('".$dataset_name."') and lower(libname)=lower('".$libname."')";
...
<div id="content">
  ...
  <a class="back-link" href="<?php echo url_for('/staff/pages/index.php?libname='.h(u($libname))); ?>">&laquo; Back to Tables List</a>
